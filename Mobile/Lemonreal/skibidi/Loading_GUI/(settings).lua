...
local Window = Fluent:CreateWindow({
    Title = "Lemon Hub Blox-Fruits [ Premium ]",
    SubTitle = "by _huyzz",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Tab Main Farm", Icon = "No" }),
    Setting = Window:AddTab({ Title = "Tab Setting Farming", Icon = "No" }),
...
ImageButton.Image = "rbxassetid://114092189935357"
...
Tabs.Misc:AddButton({
	...
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://82510499648153")[1]:GetChildren()) do
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=111174964920475" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=114092189935357" then
            wait(2.0)
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=82510499648153" then
            Hop()
            Fluent:Notify({
                Title = "Lemon Hub",
